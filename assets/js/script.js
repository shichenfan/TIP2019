...
var variableMap = {
	...
	"KDP2_score_tier":{
		"name": "KDP2 Score Tier",
		"description": "KDP2 Score Tier",
		"column_chart": false,
		"format": "decimal"
	},
	"cost":{
		"name": "Full Fed Request",
		"description": "Full Fed Request",
		"column_chart": false,
		"format": "dollar"
	},
		"Total cost":{
	...
	"emp_access":{
		...
		"description": "Whether the project connect to (or is it within) a Regional Employment Center, a Freight Cluster Area or a Regional Place",
		"column_chart": true,
		"format": "decimal"
	},
	"land_compat":{
	...
	"goods_move":{
		...
		"description": "Whether the project improve the movement of freight and is it located on ARC’s regional freight system (ASTRoMaP), GDOT’s Statewide Designated Freight Corridors or the FHWA National Highway Freight Network (NHFN)",
		"column_chart": true,
		"format": "decimal"
	},
